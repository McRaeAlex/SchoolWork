...
(define (mupllist->racketlist lst)
  ;; We should recursively go through the list and create a list from it with instead of whatever denotes a list in racket use aunit
  (if (isaunit lst)
    null
    (list (fst lst) (mupllist->racketlist (snd lst)))))
